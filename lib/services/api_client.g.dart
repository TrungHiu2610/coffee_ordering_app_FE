...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<AuthResponseDto> register(RegisterDto registerDto) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<void> updateOrderStatus(
    int id,
    Map<String, String> statusDto,
  ) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(statusDto);
    await _dio.fetch<void>(_setStreamType<void>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
  ...
  Future<List<Table>> getTables() async {
    ...
    final Map<String, dynamic>? _data = null;
    final _result =
        await _dio.fetch<List<dynamic>>(_setStreamType<List<Table>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => Table.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  Future<Table> getTableByNumber(int tableNumber) async {
    ...
    final Map<String, dynamic>? _data = null;
    final _result =
        await _dio.fetch<Map<String, dynamic>>(_setStreamType<Table>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = Table.fromJson(_result.data!);
    return value;
  }
  ...
  Future<Table> occupyTable(int tableNumber) async {
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/Tables/occupyTable/${tableNumber}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<Table> releaseTable(int tableNumber) async {
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/Tables/releaseTable/${tableNumber}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
